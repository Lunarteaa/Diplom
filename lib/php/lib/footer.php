            ...
            <div id="row_foot">
                <section id="row_foot_2">
                    ...
                    <div> 
                        ...
                        <ul id="footer_ul">
                            <li id="footer_li"><a href="main.php/#promotion">Акции</a></li>
                            <li id="footer_li"><a href="#promotion">Новинки</a></li>
                            <li id="footer_li"><a href="dilivery.php">Доставка и оплата</a></li>
                            <li id="footer_li"><a href="return.php">Возврат товара</a></li>
                        </ul>
                    </div>
                    <div>
                        <h3 id="name_foot_list">Компания</h3>
                        <ul id="footer_ul">
                            <li id="footer_li"><a href="about.php">О нас</a></li>
                            <li id="footer_li"><a href="feedback.php">Обратная связь</a></li>
                        </ul>
                    </div>  
                </section>
                <aside>
                    <div id="row_foot_3">
                        ...
                        <p id="footer_p">+7 951 505 14 91</p>
                    </div>
                    <div id="row_foot_3">
                    ...
                    <div id="row_foot_3">
                        ...
                        <p id="footer_p">г. Ротсов-на-Дону пр.Буденовский 12</p>
                    </div>
                </aside>
            </div>
        </div>
