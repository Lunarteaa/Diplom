...
class Config
{
        ...
        if ($this->correct) {
            ...
            switch ($this->type) {
                ...
                case self::ENUM:
                    ...
                    break;
                default:
                    throw new \InvalidArgumentException("Config type is unknown, has not been set or not detected");
            }
     ...
     * @return bool|mixed
     */
    public function get(string $k, $default = false)
    {
